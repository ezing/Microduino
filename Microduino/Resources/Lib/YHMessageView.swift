...
class YHMessageView: UIView,UITextViewDelegate {
    ...
    func setUpViews(){
        ...
        self.textView!.frame = CGRectMake(TextViewLeadingMargin,5,SCREEN_WIDTH - TextViewLeadingMargin - TextViewTrailingMargin - SendBtnWidth - SendBtnTrailingMargin, self.bounds.size.height-10)
        ...
        sendBtn!.titleLabel?.font = UI_FONT_14
